...
### Prerequisites
* Python 3.13+
* Tkinter (Usually included with Python, or `sudo pacman -S tk` on Arch)

### Installation
1. Clone the repo:
   ```bash
   git clone [https://github.com/Hollowbh/Tic-Tac-Toe.git](https://github.com/Hollowbh/Tic-Tac-Toe.git)

<img width="348" height="582" alt="image" src="https://github.com/user-attachments/assets/b6dd0163-6a81-4015-8f72-5ca7a91203db" />
